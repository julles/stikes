...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="modal fade" id="exercise_questionSetModal" tabindex="-1" role="dialog"
            aria-labelledby="exercise_questionSetModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="exercise_footer_create" type="button" class="btn btn-primary"
                            onclick="ExercisesaveQuestion()">Create</button>
                        <button id="exercise_footer_save" type="button" class="btn btn-success"
                            onclick="ExerciseupdateQuestion()">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
@push('js')
    ...
    class = 'form-control select2' id = 'exercise_id_topic_question'>`;
        ...
        $('#exercise_isi_soal').summernote({
            minHeight: 150,
            dialogsInBody: true
        });
        $('#exercise_pilihan_a').summernote({
            minHeight: 150,
            dialogsInBody: true
        });
        $('#exercise_pilihan_b').summernote({
            minHeight: 150,
            dialogsInBody: true
        });
        $('#exercise_pilihan_c').summernote({
            minHeight: 150,
            dialogsInBody: true
        });
        $('#exercise_pilihan_d').summernote({
            minHeight: 150,
            dialogsInBody: true
        });
        $('#exercise_penjelasan_jwb').summernote({
            minHeight: 150,
            dialogsInBody: true
        });
    </script>
